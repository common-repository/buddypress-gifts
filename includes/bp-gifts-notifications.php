...
function bp_gifts_send_gifts_notification( $to_user_id, $from_user_id ) {
	...
	$sender_gifts_link = site_url( BP_MEMBERS_SLUG . '/' . $sender_ud->user_login . '/' . BP_GIFTS_SLUG .'/' );

	$reciever_gifts_link = site_url( BP_MEMBERS_SLUG . '/' . $reciever_ud->user_login . '/' . BP_GIFTS_SLUG .'/' );
